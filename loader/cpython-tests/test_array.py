...
class UnicodeTest(StringTest, unittest.TestCase):
    ...
    def test_unicode(self):
        ...
        self.assertEqual(
            repr(a),
            # Brython 3.14.1 PEP 701 parser chokes on the original f-string
            # with escaped " inside; .format() equivalent parses fine.
            "array('{0}', '\\x00=\"\\'a\\\\b\\x80\xff\\x00\\x01\u1234')".format(self.typecode))
