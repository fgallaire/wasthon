...
# Wasthon bridge bug: PyType_Check rejects enum.IntEnum-derived classes
# (their metaclass EnumType is a subclass of type but the check fails),
# yielding `TypeError: ... must be ?`. Bypassed so the import succeeds.
try:
