...
try:
    raise ImportError  # wasthon: no OpenSSL _hashlib — route HMAC through builtin _hmac
    ...
    try:
        ...
        # _operator._compare_digest may be absent under Brython; provide a
        # fallback so the module still imports (tests exercise _hmac, not this).
